...
const DEFAULT_PROPERTY_GROUP_MAP = {
  ...
  birthday: 'general',
  signup_date: 'general',
  signup_store: 'locations',
  favorite_store: 'locations',
  recent_store: 'locations',
  last_purchase_location: 'locations',
  marketing_preferences: 'preferences',
  loyalty_member: 'loyalty',
  loyalty_signup_date: 'loyalty',
  current_loyalty_tier: 'loyalty',
  next_loyalty_tier: 'loyalty',
  loyalty_points: 'loyalty',
  loyalty_spend: 'loyalty',
}
